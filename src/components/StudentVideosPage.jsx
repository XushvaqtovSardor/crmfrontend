...
export default function StudentVideosPage() {
    ...
    return (<div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <h1 className="text-2xl font-bold text-gray-900">Dars videolari</h1>
            ...
            {loading ? (<div className="py-16 flex items-center justify-center">
                    ...
                    {filteredVideos.map((video) => (<article key={video.id} className="bg-white rounded-2xl border border-[#e6e9f2] p-5 shadow-sm">
                            ...
                            {isVideoUrl(video.file) ? (<a href={video.file} target="_blank" rel="noreferrer" className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-violet-600 hover:text-violet-700">
                                    Videoni ochish
